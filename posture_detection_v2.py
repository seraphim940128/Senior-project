...
def elbow_flexion(landmarks, side, w, h, step, round, start, start_time):
...
def shoulder_forward_elevation(landmarks, w, h, step, round, start, start_time):
    current_time = time.time()
                ...
                for name in list(exercises.keys()):
                    ...
                    if "elbow_flexion" in name:
                        ...
                        exercises[name]["start"], exercises[name]["start_time"], current_frame_error_message = \
                            elbow_flexion(landmarks, side, w, h, **params)
                        ...
                        exercises[name]["step"], exercises[name]["round"], \
                        exercises[name]["start"], exercises[name]["start_time"], current_frame_error_message = \
                            shoulder_forward_elevation(landmarks, w, h, **params)
